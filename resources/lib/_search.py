...
class Main:
    ...
    def addMenuItems( self, perpage, pagenumber , search, huluonly ):
        ...
        for item in menuitems:
            ...
            # search tree, full-description not available anymore
            # line 129 not available in search tree
            # effecting file stream_hulu.py network pre roll
            # comment line 91 & 129
            # disable network pre roll to avoid script error, set to zero 
